...
const Header: React.FC<HeaderProps> = ({ currentPage, onShowNotifications, onNavigate, adminProfile, systemSettings }) => {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <div className="text-right">
            ...
            <p className="text-xs text-gray-500">Logged in as: {adminProfile.name}</p>
          </div>
